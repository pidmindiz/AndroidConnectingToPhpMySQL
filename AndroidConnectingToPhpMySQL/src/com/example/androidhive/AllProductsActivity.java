...
public class AllProductsActivity extends ListActivity {
	...
	private static final String TAG_HORA = "chora";
	private static final String TAG_FECHA = "cfecha";
	private static final String TAG_USUARIO = "cusuario";
	private static final String TAG_PACIENTE = "cpaciente";
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							...
							new int[] { R.id.pid, R.id.paciente, R.id.usuario, R.id.hora, R.id.fecha });
					// updating listview
